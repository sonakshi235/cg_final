...
public class CrudbootApplication {
	 ...
	 */
	@Bean
	public CommandLineRunner demo(StudentRepository repository, CourseRepository crepository, UserRepository urepository, VideoRepository vrepository) {
		return (args) -> {
			// save students
			...
			vrepository.save(new Video("Diana"));
